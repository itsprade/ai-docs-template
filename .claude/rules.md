...
1. Read `INDEX.md` to understand the system
...
- [ ] Did I check the decision tree in `INDEX.md`?
...
|---------------------|---------------------|
| Find the right component | `INDEX.md` (decision trees) |
| Understand a component | `components/ui/[name]/[name].md` |
| Create a new component | `component.template.md` |
| Update indexes after creating | `MAINTENANCE.md` |
...
```
INDEX.md                       ← Read FIRST (index + decision trees)
MAINTENANCE.md                 ← Read when creating/modifying components
